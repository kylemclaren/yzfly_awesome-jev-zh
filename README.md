...
| 9 | [**awlevin/typesafe-computer-use**](https://github.com/awlevin/typesafe-computer-use) `🆕` | ![](https://badgen.net/github/stars/awlevin/typesafe-computer-use) | — | Python | Computer use for about $0.0002 a step: OCR the screen, classify the next action with TypeSafe,… |
| 10 | [**typesafe-ai/skills**](https://github.com/typesafe-ai/skills) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/skills) | — | — | Agent skills for building with TypeSafe's System One API |
| 11 | [**kitze/skillbox**](https://github.com/kitze/skillbox) `🆕` | ![](https://badgen.net/github/stars/kitze/skillbox) | — | TS | Self-hosted, versioned skills library for AI agents. MCP, scoped clients, and optional Jev reco… |
| 12 | [**NiazMorshed2007/jev-review**](https://github.com/NiazMorshed2007/jev-review) `🆕` | ![](https://badgen.net/github/stars/NiazMorshed2007/jev-review) | — | TS | Local-first MCP plugin for continuous software-quality review by AI coding agents, powered by J… |
| 13 | [**typesafe-ai/system-one-adapter-python**](https://github.com/typesafe-ai/system-one-adapter-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/system-one-adapter-python) | — | Python | Drop-in TypeSafeClient replacement backed by LLM APIs |
| 14 | [**typesafe-ai/typesafe-sdk-js**](https://github.com/typesafe-ai/typesafe-sdk-js) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-js) | — | TS | The official TypeScript/JavaScript library for the TypeSafe API |
| 15 | [**AbdelStark/awesome-typesafe**](https://github.com/AbdelStark/awesome-typesafe) `🆕` | ![](https://badgen.net/github/stars/AbdelStark/awesome-typesafe) | — | CSS | A curated list of official resources and community projects for TypeSafe, System One models, an… |
| 16 | [**gargpratyush/jev-router**](https://github.com/gargpratyush/jev-router) `🆕` | ![](https://badgen.net/github/stars/gargpratyush/jev-router) | — | JS | Route to the cheapest model in claude code for your task using jev-router |
| 17 | [**ekzhang/openjev-sglang**](https://github.com/ekzhang/openjev-sglang) `🆕` | ![](https://badgen.net/github/stars/ekzhang/openjev-sglang) | — | Python | Jev-compatible API endpoint based on open models (prefill-only) |
| 18 | [**vinilana/jev-eval-agent**](https://github.com/vinilana/jev-eval-agent) `🆕` | ![](https://badgen.net/github/stars/vinilana/jev-eval-agent) | — | HTML | — |
| 19 | [**realZachi/pg-jev**](https://github.com/realZachi/pg-jev) `🆕` | ![](https://badgen.net/github/stars/realZachi/pg-jev) | — | Python | Ask your Postgres tables questions in plain language. A PostgreSQL extension powered by TypeSaf… |
| 20 | [**vlad-terin/jev-use**](https://github.com/vlad-terin/jev-use) `🆕` | ![](https://badgen.net/github/stars/vlad-terin/jev-use) | — | JS | Jev-powered browser and desktop workflows with fewer Codex round trips. |
| 21 | [**yibie/awesome-jev**](https://github.com/yibie/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/yibie/awesome-jev) | — | Python | A curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's S… |
| 22 | [**typesafe-ai/typesafe-sdk-python**](https://github.com/typesafe-ai/typesafe-sdk-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-python) | — | Python | The official Python library for the TypeSafe API |
| 23 | [**droidrun/mobile-jev**](https://github.com/droidrun/mobile-jev) `🆕` | ![](https://badgen.net/github/stars/droidrun/mobile-jev) | — | JS | — |
...
| 32 | [**ChetasLua/jevmeter**](https://github.com/ChetasLua/jevmeter) `🆕` | ![](https://badgen.net/github/stars/ChetasLua/jevmeter) | — | Python | Put a live Jev (TypeSafe) meter on any video: every sentence scored, rendered as a 16:9 edit |
| 33 | [**dbreunig/building-with-jev-skill**](https://github.com/dbreunig/building-with-jev-skill) `🆕` | ![](https://badgen.net/github/stars/dbreunig/building-with-jev-skill) | — | — | A skill for writing and improving programs that call Jev, TypeSafe's System One model |
| 34 | [**Dicklesworthstone/skillranker**](https://github.com/Dicklesworthstone/skillranker) `🆕` | ![](https://badgen.net/github/stars/Dicklesworthstone/skillranker) | — | Rust | Rust CLI powered by Jev from TypeSafe.ai that ranks agent skills for the next step using live s… |
| 35 | [**itsmostafa/typesafe-mcp**](https://github.com/itsmostafa/typesafe-mcp) `🆕` | ![](https://badgen.net/github/stars/itsmostafa/typesafe-mcp) | — | Go | mcp connector to give your AI agent direct access to typesafe ai's jev model |
| 36 | [**standardagents/jevpilot**](https://github.com/standardagents/jevpilot) `🆕` | ![](https://badgen.net/github/stars/standardagents/jevpilot) | — | JS | A playable Three.js driving simulator with Jev-powered autopilot |
| 37 | [**kshetrajna12/reflex**](https://github.com/kshetrajna12/reflex) `🆕` | ![](https://badgen.net/github/stars/kshetrajna12/reflex) | — | Python | A small open decision model: state + typed questions -> calibrated probabilities. A Jev / Syste… |
| 38 | [**AnotiaWang/awesome-jev**](https://github.com/AnotiaWang/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/AnotiaWang/awesome-jev) | — | — | A curated list of awesome Jev / TypeSafe System One applications, libraries, and resources. |
| 39 | [**iammrduncan/typesafe-ai-benchmark**](https://github.com/iammrduncan/typesafe-ai-benchmark) `🆕` | ![](https://badgen.net/github/stars/iammrduncan/typesafe-ai-benchmark) | — | TS | This is a LLM Gateway that mimics typesafe ai structured output. Like an imposter Jev. |
| 40 | [**y0usaf/pi-jev**](https://github.com/y0usaf/pi-jev) `🆕` | ![](https://badgen.net/github/stars/y0usaf/pi-jev) | — | TS | TypeSafe Jev as a decision layer for the Pi coding agent: a measured tool-call gate plus jev_as… |
| 41 | [**jkudish/jev-browser**](https://github.com/jkudish/jev-browser) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-browser) | — | TS | Browser use using Typesafe's Jev model |
| 42 | [**realZachi/typesafe-adblock**](https://github.com/realZachi/typesafe-adblock) `🆕` | ![](https://badgen.net/github/stars/realZachi/typesafe-adblock) | — | JS | Fun project: a Chrome extension that asks a tiny AI decision model (TypeSafe Jev) "is this DOM… |
| 43 | [**snellingio/system-one**](https://github.com/snellingio/system-one) `🆕` | ![](https://badgen.net/github/stars/snellingio/system-one) | — | Python | — |
| 44 | [**wundercorp/loki**](https://github.com/wundercorp/loki) `🆕` | ![](https://badgen.net/github/stars/wundercorp/loki) | — | Python | The agent that evolves with you 𖤍 |
| 45 | [**devanshbatham/commit-miner**](https://github.com/devanshbatham/commit-miner) `🆕` | ![](https://badgen.net/github/stars/devanshbatham/commit-miner) | — | Rust | Classify Git commit diffs and messages with Jev. Bug fixes, security fixes/CWEs, and change typ… |
| 46 | [**daseinlabs/open-jev**](https://github.com/daseinlabs/open-jev) `🆕` | ![](https://badgen.net/github/stars/daseinlabs/open-jev) | — | Python | — |
...
| 55 | [**JoshuaSP/open-jev**](https://github.com/JoshuaSP/open-jev) `🆕` | ![](https://badgen.net/github/stars/JoshuaSP/open-jev) | — | Python | Typed JSON inference with DiffusionGemma, with Every and Jev benchmark results |
| 56 | [**nidhi-singh02/agent-router**](https://github.com/nidhi-singh02/agent-router) `🆕` | ![](https://badgen.net/github/stars/nidhi-singh02/agent-router) | — | TS | CLI that picks Cursor, Claude Code, Codex, or OpenCode + model/effort for a task, then launches… |
| 57 | [**r-ms/mini-jev**](https://github.com/r-ms/mini-jev) `🆕` | ![](https://badgen.net/github/stars/r-ms/mini-jev) | — | Python | mini-Jev: what a Jev-style typed-decision interface looks like on a frozen Qwen3-4B — read the… |
| 58 | [**olanotolu/jevbetter**](https://github.com/olanotolu/jevbetter) `🆕` | ![](https://badgen.net/github/stars/olanotolu/jevbetter) | — | Python | A stronger one-pass scorer over a variable list of text options. Hashed n-gram encoder, rival-a… |
...
| [**kylemclaren/jevql**](https://github.com/kylemclaren/jevql) | ![](https://badgen.net/github/stars/kylemclaren/jevql) | 类 psql 的命令行工具与 Go/TS/Python SDK，无需扩展即可在原生 Postgres 中使用 jev() 语义条件：SQL 在服务端执行，剩余行由 Jev 批量判断并本地缓存 |
